...
abstract class AbstractCommandTest {
    protected HabrTelegramBot habrbot = Mockito.mock(HabrTelegramBot.class);
    protected SendBotMessageService sendBotMessageService = new SendBotMessageServiceImpl(habrbot);
    ...
    public void shouldProperlyExecuteCommand() throws TelegramApiException {
        ...
        //then
        Mockito.verify(habrbot).execute(sendMessage);
    }
}
